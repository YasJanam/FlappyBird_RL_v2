...
class PrimitiveRenderer:
    ...
    def render(self,bird,pipe):
        self.screen_renderer()
        self.pipe_renderer(pipe)
        self.bird_renderer(bird)
        pygame.display.flip()
        self.clock.tick(30)    
    ...
    def bird_renderer(self,bird,color=(255,140,0)):
        pygame.draw.circle(self.screen, color,(50,int(bird.y)),self.bird_radius)

    def pipe_renderer(self,pipe,color=(34, 139, 34)):
